...
sshpass -v -p $password rsync -avh --exclude='*.joblib' rylansch@openmind7.mit.edu:/om2/user/rylansch/FieteLab-ddCRP/exp_01_mixture_of_gaussians/plots* exp_01_mixture_of_gaussians/
sshpass -v -p $password rsync -avh --exclude='*.joblib' rylansch@openmind7.mit.edu:/om2/user/rylansch/FieteLab-ddCRP/exp_02_mixture_of_unigrams/plots* exp_02_mixture_of_unigrams/
